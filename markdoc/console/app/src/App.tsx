...
function App() {
  ...
  return (
    <>
      ...
      <p>
        This app runs from a single HTML file. It's written with React,
        TypeScript, and Vite.
      </p>
      ...
      <ExampleWrapper>
        ...
        <p>
          The button below is styled with Emotion at the top of{" "}
      ...
      <ExampleWrapper>
        ...
        <p>
          MUI is installed, so you can use MUI components, such as the rating
          below (see{" "}
          <a href="https://mui.com/material-ui/react-rating/">
            the Rating docs
          </a>
          ).
        </p>
      ...
      <ExampleWrapper>
        <h3>Import data</h3>
        <p>
          A common use case for a single-file tooling app is to layer a UI over
          a dataset.
        </p>
        <p>
